...
export default {
    name: "purge-links",
    description: "Deletes the specified amount of messages with links in channel",
    cooldown: 5,
    aliases: ["purgelink", "purgelinks"],
    category: "Moderation",
    permissions: {
    ...
    */
    run: async ({ message, client, err, options, guildData }) => {
        try {
            ...
            const response = await purge(message.member, message.channel, "Link", amount);
